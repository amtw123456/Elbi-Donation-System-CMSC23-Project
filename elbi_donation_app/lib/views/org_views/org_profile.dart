...
class OrgProfileState extends State<OrgProfile> {
  late String statusForDonation; // should be set by current
        ...
        body: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (BuildContext context,
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (!_editing) {
                // update the status for donation
                statusForDonation = userInformation.status;
              }
                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                const Text("Status for donation",
                                    style: TextStyle(
                                        fontFamily: 'Poppins',
                                        color: Color(0xFF37A980),
                                        fontSize: 16)),
                                          ...
                                          onPressed: () async {
                                            try {
                                              ...
                                              final userId = context
                                                  ...
                                                  ?.uid;
                                              if (userId == null) {
                                                throw 'Error: current user not properly logged in.';
                                              }
                                              // update the status here
                                              final result = await context
                                                  .read<UserProvider>()
                                                  .updateUserModel(userId, {
                                                'status': statusForDonation
                                              });
